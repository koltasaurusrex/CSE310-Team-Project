...
# BASE_DIR is equivlent to the directory where manage.py lives, your project's root level directory
...
SECRET_KEY = '&36p0w4d=tug2uu3yg+h(o@aax=cqq=pk1lyq&z_(oehj7f$*e'
